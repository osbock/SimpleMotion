...
protected:
    ...
    short stop_pinf = PIN_UNCONNECTED;
    short stop_pinr = PIN_UNCONNECTED;
...
private:
    ...
    short last_dir_state;
    short steps_since_last_stop;

public:
    /*
     * Basic connection: DIR, STEP are connected.
     */
    StopStepperDriver(short steps, short dir_pin, short step_pin);
    StopStepperDriver(short steps, short dir_pin, short step_pin, short enable_pin);
    StopStepperDriver(short steps, short dir_pin, short step_pin, short enable_pin, short stop_pinf, short stop_pinr);
    /*
